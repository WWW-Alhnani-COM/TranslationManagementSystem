...
export default function CreateProjectPage() {
  ...
  // مستخدمون تجريبيون للفريق
  const MOCK_TEAM = [
    { id: "2", username: "translator1", fullName: "أحمد المترجم", role: UserRole.TRANSLATOR },
    { id: "3", username: "reviewer1", fullName: "سارة المراجعة", role: UserRole.REVIEWER },
  ];
  ...
  const handleSubmit = () => {
    // هنا يمكنك إرسال البيانات إلى الـ Backend لاحقًا
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  {MOCK_TEAM.filter(u => u.role === UserRole.TRANSLATOR).map(user => (
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  {MOCK_TEAM.filter(u => u.role === UserRole.REVIEWER).map(user => (
                    <SelectItem key={user.id} value={user.id}>
                      {user.fullName}
                    </SelectItem>
                  ))}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">اتبع الخطوات لإنشاء مشروع ترجمة جديد</p>
      </div>
      ...
      <Card>
        ...
        <CardFooter className="flex justify-between">
          ...
          {currentStep === 'review' ? (
            ...
            <Button onClick={handleNext} disabled={!projectData.name && currentStep === 'info'}>
              التالي
            </Button>
          )}
        </CardFooter>
